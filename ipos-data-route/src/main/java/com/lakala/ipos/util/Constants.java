...
public class Constants {
	 ...
	 * kafka topic
	 */
	public static final String RECEIVE_TOPIC = "appdata"; // 接收端接收到数据的topic
	public static final String DEVINFO_TOPIC = "devinfo"; // 基础信息数据的topic
	public static final String PAYMENT_TOPIC = "payment"; // 收单数据的topic
	public static final String APPMALL_TOPIC = "appmall"; // 应用商城数据的topic
	public static final String MANAGER_TOPIC = "iposmgr"; // ipos管家数据的topic
